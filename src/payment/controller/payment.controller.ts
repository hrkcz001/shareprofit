...
export class PaymentController{
    ...
    @Put('payment/:id')
    async updatePayment(@Param('id', ParseIntPipe) id: number, @Body() payment: PaymentEntity){
    ...
    async getPaymentsListInPeriod(@Query('from', ParseIntPipe) from: number, @Query('to', ParseIntPipe) to: number){
